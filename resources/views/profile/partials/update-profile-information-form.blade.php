<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="hometown" name="hometown" type="text" class="mt-1 block w-full" :value="old('hometown', $user->hometown)"
                required autofocus autocomplete="hometown" />
        ...
        <div>
            <x-input-label for="mobiel" :value="__('Mobiel')" />
            <x-text-input id="mobiel" name="mobiel" type="text" class="mt-1 block w-full" :value="old('mobiel', $user->mobiel)"
                required autofocus autocomplete="mobiel" />
            <x-input-error class="mt-2" :messages="$errors->get('mobiel')" />
        </div>
